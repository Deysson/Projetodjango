...
from .views import Homepage, Homefilmes, Detalhesfilme, Pesquisarfilme, Editarpagina, Criarconta
...
urlpatterns = [
    ...
    path('editarperfil/<int:pk>', Editarpagina.as_view(), name='editarperfil'),
